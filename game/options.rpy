...
define config.name = "The Mod In Which Natsuki Has A Nice Day And Nothing Horrible Happens To Her, Thank You Very Much"
...
define build.name = "TMIWNHANDANHHTHTYVM"
...
define config.save_directory = "TMIWNHANDANHHTHTYVM"
