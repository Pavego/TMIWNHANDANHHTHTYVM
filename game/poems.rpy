init python:
    ...
    protag_credit=Poem(author="natsuki",title="Credit for MC sprite",text="""\
======================================
...
DDLC Protagonist "character" still belongs to Team Salvato
    ...
    protag_casual_credit=Poem(author="natsuki",title="Credit for MC casual outfit",text="""\
======================================
DDLC Protagonist Casual Sprite by Childish-N & SlightlySimple
======================================

Usage
- You can use this sprite in minor works such as image edits or memes.
- You can use this sprite in major works such as mods or fan videos, however permission or credit (your choice) are required.
...
- When crediting, remember to credit both u/-Chipz- as the creator of the base sprite and u/SlightlySimple as the creator of the casual outfit
