init -2 python:
    gui.init(1280, 720)
    try:
        F = renpy.file("accessibility.txt").read()
        L=F.read().split("\n")
    except:
        L=[]
    D={'TEXT_MODIFIER':1,'TEXT_COLOR':'#ffffff'}
    for e in L:
        E=e.split(' ')
        if len(E)==2:
            D[E[0]]=E[1]
...
define -2 gui.text_color = D['TEXT_COLOR']
define -2 gui.interface_text_color = D['TEXT_COLOR']


define -2 gui.text_modifier = int(D['TEXT_MODIFIER'])
...
define -2 gui.text_size = int(24*gui.text_modifier)


define -2 gui.name_text_size = int(24*gui.text_modifier)


define -2 gui.interface_text_size = int(24*gui.text_modifier)


define -2 gui.label_text_size = int(28*gui.text_modifier)


define -2 gui.notify_text_size = int(16*gui.text_modifier)


define -2 gui.title_text_size = int(38*gui.text_modifier)
...
define -2 gui.quick_button_text_size = int(14*gui.text_modifier)
...
define -2 gui.slot_button_width = int(276*gui.text_modifier)
define -2 gui.slot_button_height = int(206*gui.text_modifier)
define -2 gui.slot_button_borders = Borders(10, 10, 10, 10)
define -2 gui.slot_button_text_size = int(14*gui.text_modifier)
...
init -2 python:
    ...
    if renpy.variant("small"):
        ...
        gui.text_size = 30*gui.text_modifier
        gui.name_text_size = 36*gui.text_modifier
        gui.notify_text_size = 25*gui.text_modifier
        gui.interface_text_size = 36*gui.text_modifier
        gui.button_text_size = 34*gui.text_modifier
        gui.label_text_size = 36*gui.text_modifier
        ...
        gui.quick_button_text_size = 20*gui.text_modifier
